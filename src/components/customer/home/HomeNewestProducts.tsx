 ...
 * ============================================================
 *
 * Section produk terbaru homepage.
 *
 * Visual:
 * - Deep Ocean sebagai warna utama
 * - Fresh Green sebagai accent
 * - Konsisten dengan Produk Pilihan & Produk Terlaris
 ...
 * ============================================================
 *
 * Tidak memerlukan createdAt karena data tersebut tidak digunakan
 * untuk proses rendering komponen.
 */

interface HomeNewestProductsProps {
  products:
...
export default function HomeNewestProducts({
  products,
  productsHref,
}: HomeNewestProductsProps) {
  /**
    ...
    <div className="flex items-center gap-2.5 sm:gap-3">
      ...
      <div className="min-w-0">
        ...
        <p className="mt-0.5 line-clamp-1 text-[10px] text-[var(--ink-500)] sm:text-sm">
          Produk seafood segar terbaru untuk Anda
        </p>
