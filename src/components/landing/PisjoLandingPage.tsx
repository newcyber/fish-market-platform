...
export default async function PisjoLandingPage() {
  ...
  const androidUrl = urls.android ?? urls.store;
    ...
    <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 py-20 sm:px-6 lg:grid-cols-2 lg:px-8 lg:py-24">
      <div className="max-w-xl">
        ...
        <div className="mt-7">
          <a
            href={androidUrl}
            className="inline-flex min-h-12 items-center gap-2 rounded-2xl bg-[var(--pisjo-navy)] px-6 text-sm font-bold text-white transition hover:-translate-y-0.5 hover:bg-slate-800"
          >
            <Smartphone className="h-5 w-5" />
        ...
        {appImage ? (
          ...
          <div className="relative w-full max-w-sm overflow-hidden rounded-[2.5rem] border border-white bg-white p-4 shadow-xl sm:p-5">
            <div className="relative aspect-[4/3] w-full overflow-hidden rounded-[2rem] bg-slate-50">
              <Image
                src={appImage}
                alt={app.title || `${storeName} Android App`}
                fill
                className="object-contain"
...
/>
      <div className="relative z-10 flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex flex-col gap-3 sm:flex-row lg:shrink-0">
          ...
          >
            {cta.buttonLabel || "Kunjungi Store"}
            <ArrowRight className="h-4 w-4" />
          </a>
          ...
          >
            ...
            {androidAvailable ? "Download Android" : "Buka di Android"}
          </a>
        </div>
      </div>
    </div>
