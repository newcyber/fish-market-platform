...
interface ShippingMethodSelectorProps {
  ...
  selectedProvider: ShippingProviderCode | null;

  onChange: (provider: ShippingProviderCode) => void;
          ...
          >
            ...
            <div className="min-w-0 w-full">
              ...
              <p
                ...
                "
              >
                {getProviderDescription(provider.code)}
              </p>
            </div>
...
function getProviderDescription(providerCode: ShippingProviderCode): string {
  switch (providerCode) {
    case "PICKUP":
